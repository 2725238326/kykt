...
parser.add_argument('--testpath', default='/hdd/2/yxn/data/dtu_test/dtu/', help='testing data path')
...
parser.add_argument('--loadckpt', default='checkpoints/d192/model_000010.ckpt', help='load a specific checkpoint')
...
def filter_depth(scan_folder, out_folder, plyfilename):
    ...
    for ref_view, src_views in pair_data:
        ...
        for src_view in src_views:
            ...
            geo_mask_sum += geo_mask.astype(int)
