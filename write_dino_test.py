...
Path('/hdd3/kykt26/code/dream3r/dream3r/tests/test_dinov2_backbone.py').write_text(r'''"""Tests for W11 frozen DINO-style Perceiver backbone."""
...
class FakeDINO(nn.Module):
    ...
    def forward(self, x):
        ...
        return tokens * base.unsqueeze(-1) * self.weight
