...
conda run -n mast3r python /tmp/mast3r_runner.py --job-dir "$JOB" --model /hdd3/kykt26/code/mast3r/checkpoints/MASt3R_ViTLarge_BaseDecoder_512_catmlpdpt_metric.pth --repo /hdd3/kykt26/code/mast3r --image-size 512 --scene-graph complete --niter 300 --lr 0.01 --batch-size 1 --max-points 120000 --match-viz-count 30
ls -lah "$JOB/output"